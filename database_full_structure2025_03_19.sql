...
-- Generation Time: Mar 19, 2025 at 01:51 AM
...
CREATE TABLE `users` (
  ...
  `verification_token_expires` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE `user_activity_logs` (
  `id` int NOT NULL,
  `user_id` int DEFAULT NULL,
  `activity_type` enum('login','logout','registration','password_reset','email_verification','profile_update','failed_login') COLLATE utf8mb4_general_ci NOT NULL,
  `ip_address` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `user_agent` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
