...
import { Wifi, WifiOff, RefreshCw, Inspect, AlertTriangle } from "lucide-react";
...
export default function NetworkErrorBoundary({
  ...
  // Add a refresh function that uses router.refresh() instead of window.location
  const refreshPage = useCallback(() => {
    router.refresh(); // Use router.refresh() which is safer than full page reload
  }, [router]);
