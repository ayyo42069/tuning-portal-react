          ...
          <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8 relative z-10">
            <div className="px-4 py-6 sm:px-0">
              <div className="bg-white/5 dark:bg-gray-800/5 backdrop-blur-sm shadow-xl overflow-hidden sm:rounded-xl border border-white/10 dark:border-gray-700/30 hover:shadow-2xl transition-all duration-300">
                ...
                {/* Detailed Progress */}
                <div className="px-6 py-6 sm:px-8 border-t border-white/10 dark:border-gray-700/30 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 dark:from-cyan-900/30 dark:to-blue-900/30 backdrop-blur-sm">
                ...
                {tuningFile.status === "completed" &&
                  tuningFile.processed_filename && (
                    <div className="px-6 py-6 sm:px-8 border-t border-white/10 dark:border-gray-700/30 bg-gradient-to-r from-green-500/10 to-emerald-500/10 dark:from-green-900/30 dark:to-emerald-900/30 backdrop-blur-sm">
                ...
                {/* Comments Section */}
                <div className="px-6 py-6 sm:px-8 border-t border-white/10 dark:border-gray-700/30 bg-gradient-to-r from-blue-500/10 to-indigo-500/10 dark:from-blue-900/30 dark:to-indigo-900/30 backdrop-blur-sm">
                  <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white mb-4">
                    Comments & Questions
                  </h3>
                  <ECUFileComments
