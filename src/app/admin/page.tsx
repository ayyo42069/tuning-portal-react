...
// Stats widget with its own loading state and error handling
async function StatsWidget() {
  try {
    const stats = await fetchAdminDashboardStats();
    
    // Check if stats has error property or is not properly shaped
    if (stats.error) {
      return (
...
// Recent activity widget with its own loading state and error handling
